...
* **서로게이트 페어 한자 글자수 카운트 오류 수정**
  
  * 전체 글자수, 한자수, 동일 한자, A·B 차이 글자수 모두 해당
    
  * LCS 알고리즘 내 문자열 인덱싱 오류 수정
    
* **CJK 확장 H·I 범위 추가**
  
  * CJK 확장 H (Unicode 15.0, 2022): U+31350–U+323AF
    
  * CJK 확장 I (Unicode 15.1, 2023): U+2EBF0–U+2EE5F
